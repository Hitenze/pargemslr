...
/* print the commands for the ILUT */
int print_ilu_usage();

/* print the commands for the polynomial */
int print_poly_usage();

/* print the commands for the GeMSLR */
int print_gemslr_usage();

/* print the commands for the FlesGMRES */
...
/* print the commands for the sequential_test.ex */
int print_sequential_test_usage();

/* print the commands for the parallel_test.ex */
