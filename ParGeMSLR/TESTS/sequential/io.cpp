...
int read_inputs_from_file(const char *filename, double *params)
{
   ...
   while(fgets(line, 1024, f))
   {
      ...
      switch(linenum)
      {
         ...
         case 8:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_PREPOSS_NLEV_GLOBAL]);
            break;
         }
         case 9:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_PREPOSS_NLEV_LOCAL]);
            break;
         }
         case 10:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_PREPOSS_NCOMP_GLOBAL]);
            break;
         }
         case 11:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_PREPOSS_NCOMP_LOCAL]);
            break;
         }
         case 12:
         {
         ...
         case 14:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_DROPTOL_B_GLOBAL]);
            params[PARGEMSLR_IO_ILU_DROPTOL_B_LOCAL] = params[PARGEMSLR_IO_ILU_DROPTOL_B_GLOBAL];
            break;
         }
         case 15:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_DROPTOL_C_GLOBAL]);
            params[PARGEMSLR_IO_ILU_DROPTOL_C_LOCAL] = params[PARGEMSLR_IO_ILU_DROPTOL_C_GLOBAL];
            break;
         }
         case 16:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_ROWNNZ_B_GLOBAL]);
            params[PARGEMSLR_IO_ILU_ROWNNZ_B_LOCAL] = params[PARGEMSLR_IO_ILU_ROWNNZ_B_GLOBAL];
            break;
         }
         case 17:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_ROWNNZ_C_GLOBAL]);
            params[PARGEMSLR_IO_ILU_ROWNNZ_C_LOCAL] = params[PARGEMSLR_IO_ILU_ROWNNZ_C_GLOBAL];
            break;
         }
         case 18:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_LFIL_B_GLOBAL]);
            params[PARGEMSLR_IO_ILU_LFIL_B_LOCAL] = params[PARGEMSLR_IO_ILU_ROWNNZ_B_GLOBAL];
            break;
         }
         case 19:
         {
            sscanf(line, "%lf", &params[PARGEMSLR_IO_ILU_LFIL_C_GLOBAL]);
            params[PARGEMSLR_IO_ILU_LFIL_C_LOCAL] = params[PARGEMSLR_IO_ILU_ROWNNZ_C_GLOBAL];
            break;
         }
         case 20:
         {
