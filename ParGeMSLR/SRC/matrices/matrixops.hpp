...
namespace pargemslr
{
    ...
    */
   template <class VectorType, class MatrixType, typename DataType, typename RealDataType>
   int PargemslrArnoldiThickRestartNoLock2( MatrixType &A, int msteps, int maxits, int rank, int rank2, RealDataType truncate, RealDataType tr_fact, RealDataType tol_eig, char opt, DenseMatrixClass<DataType> &V, DenseMatrixClass<DataType> &H, RealDataType tol_orth, RealDataType tol_reorth, int &nmvs);
    ...
    */
   template <typename T>
   int PargemslrArnoldiThickRestartChooseEigenValuesReal2( DenseMatrixClass<T> &H, DenseMatrixClass<T> &Q, T h_last, T (*weight)(ComplexValueClass<T>), T truncate, int &ncov, int &nicov, int &nsatis, T tol_eig, bool &cut, SequentialVectorClass<T> &wr, SequentialVectorClass<T> &wi, vector_int &icov, vector_int &iicov, vector_int &isatis, SequentialVectorClass<T> &dcov, SequentialVectorClass<T> &dicov, SequentialVectorClass<T> &dsatis);
    ...
    */
   template <typename DataType, typename RealDataType>
   int PargemslrArnoldiThickRestartChooseEigenValuesComplex2( DenseMatrixClass<DataType> &H, DenseMatrixClass<DataType> &Q, DataType h_last, RealDataType (*weight)(DataType), RealDataType truncate, int &ncov, int &nicov, int &nsatis, RealDataType tol_eig, bool &cut, SequentialVectorClass<DataType> &w, vector_int &icov, vector_int &iicov, vector_int &isatis, SequentialVectorClass<RealDataType> &dcov, SequentialVectorClass<RealDataType> &dicov, SequentialVectorClass<RealDataType> &dsatis);
